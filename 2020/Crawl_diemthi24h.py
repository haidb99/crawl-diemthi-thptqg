...
def Crawler2020(ma_tinh, chrome_path, save_path, so_luong = 999999, start = -1, chrome_options = 0):
    ...
    while(1):
        ...
        try:
            description = driver.find_element_by_id('txt_tra_diem_ptth_sbd')
            description.clear()
        ...
        while(1):
            ...
            list_info = []
            try:
                list_info = driver.find_element_by_id('box_tra_diem_ptth_2019').find_element_by_tag_name('tbody').find_elements_by_tag_name('td')
            except:
                pass
            ...
            student['Lich_su'], student['Dia_ly'], student['GDCD'], student['Diem_KHXH'] = [x.text for x in list_info[0:13]]
            break
